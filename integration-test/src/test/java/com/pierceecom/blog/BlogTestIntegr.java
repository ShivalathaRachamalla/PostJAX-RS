...
public class BlogTestIntegr {
    ...
    /**
     * As per the json specification , json is unordered name/value pairs.
     * So using JsonParser to compare with expected json string with POST_1 or POST_2
     */
    ...
    public void test_3_GetPost() {
        ...
        JsonElement o1 = parser.parse(POST_1);
        JsonElement o2 = parser.parse(postJson);
        assertEquals(o1, o2);

        postJson = GET(POSTS_URI + "2", 200);
        JsonElement o3 = parser.parse(POST_2);
        JsonElement o4 = parser.parse(postJson);
        assertEquals(o3, o4);
    }
    ...
    public void test_4_GetAllPosts() {
        String output = GET(POSTS_URI, 200);
        JsonElement o1 = parser.parse("[" + POST_1 + "," + POST_2 + "]");
        JsonElement o2 = parser.parse(output);
        assertEquals(o1, o2);
    }
